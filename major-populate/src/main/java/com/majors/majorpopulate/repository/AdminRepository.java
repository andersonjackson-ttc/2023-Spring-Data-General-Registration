...
/* potentially updates all fields for a section. Only updates passed in fields. This should recieve a HashTable<string,string> where the key: field_name, value:field_value */
